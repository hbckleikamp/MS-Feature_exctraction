...
fdf=pd.read_csv("E:/Proteomics_Jeanine/mzML/B004241_Bp_PRC-2296_Remaut_shotgun_1_20180722184121_calibrated_protein_isotoplogue.tsv",index_col=[0],sep="\t")#.iloc[:10]
...
if __name__== '__main__':
    ...
    dfs.to_csv("C:\Metabolomics\Buddy\Buddy_python_proteins_charge_corrected.tsv",sep="\t")
    print("done")
